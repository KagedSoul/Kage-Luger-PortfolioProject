...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://kageluger.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://kageluger.devcamp.space/portfolio/portfolio_blogs/${this.props.blogToEdit.id}`,
        apiAction: "patch",
      });
    }
  }
  ...
  handleRichTextEditorChange(content) {
    ...
    // this.setState({
    //   content: content
    //   This is an alternitate method since the content arument is the same as the the key
    // })
        ...
        <div className="image-uploaders">
          {this.props.editMode && this.props.blogToEdit.featured_image_url ? (
            <div className="portfolio-manager-image-wrapper">
              <img src={this.props.blogToEdit.featured_image_url}></img>
